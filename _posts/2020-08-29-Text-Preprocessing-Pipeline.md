...
```python
text = "BERT Language Model (NLP) blog post on https://towardsdatascience.com/bert-explained-state-of-the-art-language-model-for-nlp-f8b21a9b6270"
remove_urls(text)
```
    ...
    'BERT Language Model (NLP) blog post on '
...
```python
text = "Want to know more. Checkout www.xyz.ai for additional information"
remove_urls(text)
```
...
<h1> NLP</h1>
<p> Language Model</p>
<a href="https://towardsdatascience.com/bert-explained-state-of-the-art-language-model-for-nlp-f8b21a9b6270"> BERT Introduction</a>
</div>"""
...
[Source](https://github.com/rishabhverma17/sms_slang_translator/blob/master/slang.txt): We can use this for our conversion here. We can add more words to this list.
...
```python
text = "thnks for atending the NLP sesion"
correct_spellings(text)
```
    ...
    'thanks for attending the NLP session'
